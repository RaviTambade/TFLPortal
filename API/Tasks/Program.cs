...
builder.Services.AddTransient<ITaskAllocationRepository,TaskAllocationRepository>();
builder.Services.AddTransient<ITaskAllocationService,TaskAllocationService>();
