...
public class ProjectsRepository : IProjectsRepository
{
    ...
    public async Task<bool> Insert(Project project)
    {
        ...
        try
        {
            string query = "INSERT INTO projects(title,startdate,enddate,description,teammanagerid,status) VALUES(@projtitle,@startdate,@enddate,@projdesc,@teammanagerid,@status)";
            MySqlCommand command = new MySqlCommand(query, con);
    ...
    public async Task<bool> Update(Project project)
    {
        ...
        try
        {
            string query = "Update projects SET title =@projtitle, startdate=@startdate,enddate=@enddate,description=@projdesc,teammanagerid=@teammanagerid,status=@status WHERE id=@projId";
            MySqlCommand command = new MySqlCommand(query, con);
            command.Parameters.AddWithValue("@projtitle", project.Title);
            command.Parameters.AddWithValue("@startdate", project.StartDate);
            command.Parameters.AddWithValue("@enddate", project.EndDate);
