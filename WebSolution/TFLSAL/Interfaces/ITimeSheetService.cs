...
public interface ITimesheetService
{
    ...
    Task<List<TimesheetViewModel>> GetTimesheets( int hrmanagerId,string status,string fromDate,string toDate);
    ...
    Task<List<ProjectWorkHours>> GetProjectWiseTimeSpentByEmployee(int employeeId,string fromDate,string toDate);
