...
import { TimesheetEntry } from '../Models/Timesheet/timesheetEntry';
import { ProjectWorkHour } from '../Models/Timesheet/projectworkhour';
import { Week } from '../Models/Timesheet/Week';
...
export class TimesheetService {
    ...
    getEmployeeUtilizationByProject(employeeId:number,projectId:number,fromDate: string, toDate:string): Observable<Performance> {
