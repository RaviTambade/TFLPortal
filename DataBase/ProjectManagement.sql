...
CREATE TABLE teams(team_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, team_name VARCHAR (50)UNIQUE);
CREATE TABLE roles(role_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,role_name varchar (50));
CREATE TABLE team_members(team_member_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, team_id INT NOT NULL, CONSTRAINT fk_teamid FOREIGN KEY (team_id) REFERENCES teams (team_id)ON UPDATE CASCADE  ON DELETE CASCADE ,role_id INT NOT NULL, CONSTRAINT fk_roleid FOREIGN KEY (role_id) REFERENCES roles(role_id)ON UPDATE CASCADE  ON DELETE CASCADE,emp_id INT NOT NULL, CONSTRAINT fk_emp_Id4 FOREIGN KEY(emp_id) REFERENCES employees(emp_id) ON UPDATE CASCADE ON DELETE CASCADE);
CREATE TABLE projects(proj_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,proj_name VARCHAR(100),startDate DATETIME NOT NULL,endDate DATETIME NOT NULL,proj_desc VARCHAR(255),team_id INT NOT NULL, CONSTRAINT fk_teamId1 FOREIGN KEY (team_id) REFERENCES teams(team_id)ON UPDATE CASCADE  ON DELETE CASCADE);
CREATE TABLE project_manager(pm_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,proj_id INT NOT NULL, CONSTRAINT fk_proid FOREIGN KEY (proj_id) REFERENCES projects(proj_id)ON UPDATE CASCADE  ON DELETE CASCADE,user_id INT NOT NULL, CONSTRAINT fk_userid FOREIGN KEY (user_id) REFERENCES users(user_id)ON UPDATE CASCADE  ON DELETE CASCADE);
CREATE TABLE clients(client_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,clt_name VARCHAR(50),clt_address VARCHAR(200),clt_details VARCHAR(200),account_number VARCHAR(25) NOT NULL UNIQUE ,CONSTRAINT fk_account_no2 FOREIGN KEY(account_number) REFERENCES accounts(account_number) ON UPDATE CASCADE ON DELETE CASCADE);
CREATE TABLE on_project(on_project_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,proj_id INT NOT NULL, CONSTRAINT fk_projid FOREIGN KEY (proj_id) REFERENCES projects(proj_id)ON UPDATE CASCADE  ON DELETE CASCADE,client_id INT NOT NULL, CONSTRAINT fk_clientid FOREIGN KEY (client_id) REFERENCES clients(client_id)ON UPDATE CASCADE  ON DELETE CASCADE);
CREATE TABLE tasks(task_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,task_name VARCHAR(50),proj_id INT NOT NULL, CONSTRAINT fk_proidd FOREIGN KEY (proj_id) REFERENCES projects(proj_id)ON UPDATE CASCADE  ON DELETE CASCADE,description VARCHAR(200),start_date DATETIME,end_date DATETIME);
CREATE TABLE assigned(assign_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,task_id INT NOT NULL, CONSTRAINT fk_taskid FOREIGN KEY (task_id) REFERENCES tasks(task_id)ON UPDATE CASCADE  ON DELETE CASCADE,emp_id INT NOT NULL, CONSTRAINT fk_empidd FOREIGN KEY (emp_id) REFERENCES employees(emp_id)ON UPDATE CASCADE  ON DELETE CASCADE,role_id INT NOT NULL, CONSTRAINT fk_roleidd FOREIGN KEY (role_id) REFERENCES roles(role_id)ON UPDATE CASCADE  ON DELETE CASCADE);
...
INSERT INTO teams(team_name)VALUES('alpha-1');
INSERT INTO teams(team_name)VALUES('alpha-2');
INSERT INTO teams(team_name)VALUES('alpha-3');
...
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(1,1,1);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(1,2,1);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(1,3,3);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(1,4,3);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(1,13,2);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(1,11,4);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(2,5,1);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(2,6,1);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(2,7,3);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(2,8,3);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(2,12,4);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(3,1,1);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(3,5,1);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(3,7,3);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(3,8,3);
INSERT INTO team_members(team_id,emp_id,role_id)VALUES(3,10,4);

INSERT INTO projects(proj_name,startDate,endDate,proj_desc,team_id)VALUES('Online Meeting Sheduling','2021-02-02','2021-03-03','Compeny requirement want to organize meetins online',1);
INSERT INTO projects(proj_name,startDate,endDate,proj_desc,team_id)VALUES('Online Interview Sheduling','2022-05-10','2022-05-13','We want to argent hiring of new employeess for new projects',2);
INSERT INTO projects(proj_name,startDate,endDate,proj_desc,team_id)VALUES('MockTesting Sheduling','2021-02-02','2021-03-03','Compeny requirement want to organize meetins online',3);
...
INSERT INTO project_manager(proj_id,user_id)VALUES(3,12);

INSERT INTO clients(clt_name,clt_address,clt_details,account_number)VALUES('Vishwambhar Kapare','Pune RajguruNagar','Client want to create online meeting portal for their compeny','1001');
INSERT INTO clients(clt_name,clt_address,clt_details,account_number)VALUES('Rajat Pisal','Kolhapur','Client want to create online Interview Sheduling Project','1002');

INSERT INTO on_project(proj_id,client_id)VALUES(1,2);

INSERT INTO tasks(task_name,proj_id,description,start_date,end_date)VALUES('Meeting Sheduling',1,'please arrange the meeting sheduling prosess quickly','2021-02-01','2021-02-03');
